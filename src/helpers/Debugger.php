...
class Debugger implements DebuggerInterface
{
    ...
    public function deleteOldLogs()
    {
        ...
        DB::select("DELETE FROM ".PREFIX."debugger_log WHERE created_at < DATE_SUB(NOW(), INTERVAL ".$deleteFrequency." DAY)");
        DB::select("DELETE FROM ".PREFIX."debugger_log_parent WHERE created_at < DATE_SUB(NOW(), INTERVAL ".$deleteFrequency." DAY)");
    ...
    public function insertDebuggerParentDetails($message)
    {
        ...
        $id =  DB::table('debugger_log_parent')
            ->insertGetId($values);
